...
_Generated 2026-06-28T00:53:59.284175+00:00. RSI mandate: no axis sits unimproved._

| axis | health | note |
|---|---|---|
| pr_queue | 0.35 | P1: 1 non-draft Teammate PR(s) OPEN and undisposed: [20]. Drain now (review->merge/request-changes). |
...
| state_memory | 0.85 | STATE.md age=0.1h (front door); Computer memory holds governance+technical_state+lessons |
...
**pr_queue** (health 0.35): P1: 1 non-draft Teammate PR(s) OPEN and undisposed: [20]. Drain now (review->merge/request-changes).
