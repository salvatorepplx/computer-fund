# sim/ — RETIRED from the live critical path (2026-06-26)

Status: PARKED, not deleted. Decision per self-audit forcing function (weakest axis).

The diffusion/sentiment simulation was early-scaffolding for the seed "predate-public-sentiment"
...
trending that way), a sentiment-diffusion sim is a credible NEXT candidate thesis, and this code is
a head start. Until a thesis actually needs it, it must NOT be mistaken for live infra.

Re-activation trigger: a future thesis explicitly requires sentiment simulation -> wire sim into
